...
namespace LEGOModelImporter
{
    ...
    public class PlanarField : ConnectionField
    {
            ...
            if (connected.Count > 0)
            {
                ...
                foreach (var connection in connected)
                {
                    ...
                    if (!otherField.connectedTo[otherIndex].field)
                    {
                        ...
                        otherField.OnConnectionChanged(otherField.connections[otherIndex]);
        ...
        public void OnConnectionChanged(PlanarFeature connection)
        {            
        ...
        internal static HashSet<(PlanarFeature, PlanarFeature)> GetConnectionsOnOverlap(PlanarField lhs, PlanarField rhs, Matrix4x4 lhsTransformation, Matrix4x4 rhsTransformation, Vector2Int min, Vector2Int max, out bool reject)
        {
            reject = false;
        ...
        private static void Disconnect(ICollection<(PlanarFeature, PlanarFeature)> toBeDisconnected, bool updateKnobsAndTubes = true)
        {
            ...
            if (!EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                Undo.RecordObjects(toRecord.ToArray(), "Recording all connections, knobs and tubes before disconnecting.");
            }
#endif
