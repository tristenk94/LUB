...
namespace LEGOModelImporter
{
    ...
    public class ModelImporter
    {
        ...
        private static void DetectConnectivity(HashSet<Brick> onlyConnectTo, HashSet<Brick> ignoreForCollision = null)
        {
            ...
            foreach (var brick in onlyConnectTo)
            {
                ...
                foreach(var field in fields)
                {
                    ...
                    {
                        var connections = BrickBuildingUtility.Connect(connection, otherConnection, onlyConnectTo, ignored);
        ...
        {
            var brickBuilding = ToolsSettings.IsBrickBuildingOn;     
            ...
            ToolsSettings.IsBrickBuildingOn = brickBuilding;
